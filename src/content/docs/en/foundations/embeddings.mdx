...
<OpenQuestions questions={[
  { q: "What is the fundamental difference between static word vectors (word2vec, GloVe) and contextualized representations (ELMo)? Is this evolution inevitable?", papers: ["mikolov2013-word2vec", "pennington2014-glove", "peters2018-elmo"] },
  { q: "What is the mathematical connection between negative sampling's objective function and implicit matrix factorization?", papers: ["mikolov2013-skipgram-negsampling"] },
  { q: "How can embedding quality for multilingual or low-resource languages be systematically improved? How does vocabulary construction affect embedding learning?", papers: ["mikolov2013-word2vec"] },
]} />
</TierBlock>
