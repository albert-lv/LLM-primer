...
papers: ['brown2020-gpt3', 'wei2022-cot', 'snell2024-test-time-compute', 'willard2023-constrained', 'chen2023-spec-sampling', 'leviathan2023-spec-decoding', 'berkeley2026-parallel-reasoning']
...
The new development in 2026 is test-time compute shifting from "spend more" to "allocate wisely": work such as Adaptive Parallel Reasoning ([[ref:berkeley2026-parallel-reasoning]]) uses reinforcement learning to let models learn to allocate inference compute by problem difficulty—short serial reasoning for easy problems, and automatically spawned parallel reasoning threads that converge for hard ones, breaking the length bottleneck of serial chain-of-thought. This can be seen as a natural extension of decoding strategy: decoding is no longer just "how to pick the next token," but "how much compute the whole reasoning process should spend, and in what topology."
...
<OpenQuestions questions={[
  ...
  { q: "In adaptive parallel reasoning, how does the optimal mix of parallel threads and serial depth vary with task type? Do RL-learned compute allocation policies generalize across domains?", papers: ["berkeley2026-parallel-reasoning", "snell2024-test-time-compute"] },
]} />
</TierBlock>
...
<PaperList ids={['brown2020-gpt3', 'wei2022-cot', 'snell2024-test-time-compute', 'willard2023-constrained', 'chen2023-spec-sampling', 'leviathan2023-spec-decoding', 'berkeley2026-parallel-reasoning']} />
