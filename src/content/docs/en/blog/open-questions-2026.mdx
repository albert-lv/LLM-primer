...
<BlogInteraction
  title="Interactive: Turn an open question into a research question"
  prompt="Pick one open question and check whether it is concrete enough."
  checkpoints={['It has observable inputs and outputs', 'It has at least one baseline or control group', 'A negative result would still teach us something']}
  revealLabel="Suggested interpretation"
  revealText="When all three are true, the question is closer to an executable research plan than a broad topic list."
/>
